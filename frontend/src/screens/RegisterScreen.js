...
const RegisterScreen = () => {
  ...
  const handleContinue = async () => {
    if (useEmail) {
      ...
      if (res.exists) {
        Alert.alert(
          "Tài khoản đã tồn tại rồi",
          "Nếu bạn đã có một tài khoản rồi, hãy thử đăng nhập!",
          [
      ...
      navigation.navigate('Password', { email, phone: null, mode: "register" });
    } else {
      ...
      navigation.navigate('Password', { email: null, phone: phoneNumber , mode: "register" });
    }
  };
